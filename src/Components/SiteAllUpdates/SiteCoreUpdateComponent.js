...
class SiteCoreUpdateComponent extends Component {
    componentDidMount() {
        this.props.dispatch(
            WordpressContainerActionV1.wordpressContainer("core")
        );
    }
    updateAllCore = (type, slug, identities) => {
        const updateDetails = {
            type,
            slug,
            identities,
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <TemplateMain>
                    <UpdateSubMenuComponent active="core" />

                    <div className="site-allupdate-page site-core-update">
...
export default connect(mapStateToProps)(SiteCoreUpdateComponent);
