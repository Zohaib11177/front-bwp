...
class SiteThemeUpdateComponent extends Component {
    componentDidMount() {
        this.props.dispatch(
            WordpressContainerActionV1.wordpressContainer("theme")
        );
    }
    updateAllTheme = (type, slug, identities) => {
        const updateDetails = {
            type,
            slug,
            identities,
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <TemplateMain>
                    <UpdateSubMenuComponent active="theme" />

                    <div className="site-allupdate-page site-theme-update">
...
export default connect(mapStateToProps)(SiteThemeUpdateComponent);
